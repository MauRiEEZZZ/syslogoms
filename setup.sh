...
wget https://github.com/Microsoft/OMS-Agent-for-Linux/blob/master/installer/conf/omsagent.d/security_events.conf -O /etc/opt/microsoft/omsagent/security_events.conf
